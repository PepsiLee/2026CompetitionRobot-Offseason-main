...
public final class FieldConstants {
  ...
  // These are conservative software bring-up points and must be field-validated
  // before full-speed use.
  public static final Pose2d BLUE_LEFT_START = new Pose2d(4.50, 7.35, Rotation2d.fromDegrees(90.0));
  public static final Pose2d BLUE_LEFT_COLLECT_ENTRY = new Pose2d(6.30, 7.00, Rotation2d.kZero);
  public static final Pose2d BLUE_LEFT_COLLECT_SWEEP = new Pose2d(8.30, 7.00, Rotation2d.kZero);
  public static final Pose2d BLUE_LEFT_RETURN_SCORE = new Pose2d(3.20, 6.10, Rotation2d.k180deg);

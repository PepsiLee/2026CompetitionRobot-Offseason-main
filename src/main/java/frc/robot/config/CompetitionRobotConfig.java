...
public final class CompetitionRobotConfig implements RobotConfiguration {
        ...
        private static final double SPEED_AT_12_VOLTS_METERS_PER_SECOND = 4.65;
        private static final double MAX_LINEAR_SPEED_METERS_PER_SECOND = 4.65;

        // Order is always front-left, front-right, back-left, back-right.
        private static final ModuleHardware FRONT_LEFT = new ModuleHardware(1, 2, 15, 0.094482421875, false);
        ...
        public CompetitionRobotConfig() {
                ...
                SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>[] modules = new SwerveModuleConstants[] {
                                createModule(
                                                FRONT_LEFT, halfWheelbase, halfTrackWidth, driveMotorConfig,
                                                steerMotorConfig),
                                createModule(
                                                FRONT_RIGHT, halfWheelbase, -halfTrackWidth, driveMotorConfig,
                                                steerMotorConfig),
                                createModule(
                                                BACK_LEFT, -halfWheelbase, halfTrackWidth, driveMotorConfig,
                                                steerMotorConfig),
                                createModule(
                                                BACK_RIGHT, -halfWheelbase, -halfTrackWidth, driveMotorConfig,
                                                steerMotorConfig)
                };
